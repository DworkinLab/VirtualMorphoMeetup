...
### I.e., *N**C**S* will tend to make smaller objects larger in relative size, if landmark density is the same.
...
![](heads.or.tails.combined.landmarks_files/figure-markdown_strict/unnamed-chunk-16-1.png)
